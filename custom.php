...
<body>
	...
	<div class="section">
		...
		<div class="container">
			<!-- row -->
			<div class="row">
				<form class="clearfix" action="function/aksi_custom.php" method="post">
					...
					<div class="col-md-12">
						<div class="order-summary clearfix">
											...
											<div class="col-md-6">
												<div class="billing-details">
													...
													<!-- <?php
														...
														if($notif == "maxName"){
															echo "<div class='alert alert-danger'>Maximal Panjang Nama hanya 7 karakter!</div>";
														}
													?> -->
													<div class="form-group">
														<input class="input" type="text" name="name" placeholder="Nama Untuk di Kustom" required>
													</div>
													<div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input class='input' name="jumlah" type='number' value="1" min='1'>
                          </div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="shiping-methods">
													<div class="section-title">
														<h4 class="title">Contoh Sepatu</h4>
													</div>
												</div>
                        <div class="text-center">
                          <img src="img/kanvas.jpg" class="rounded img-fluid" height="300" width="199" alt="sepatu">
                        </div>
											</div>
									</div>
									<!-- /row -->
